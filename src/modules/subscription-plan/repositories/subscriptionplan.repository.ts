...
import { logger } from '@core/logs/logger';
  ...
  export class SubscriptionPlanRepository {
    ...
    async findAndCount(where?: Record<string, any>): Promise<[SubscriptionPlan[], number]> {
      logger.info('Ready to findByField SubscriptionPlan on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of SubscriptionPlan with id:  was finded on repository:', instance);
