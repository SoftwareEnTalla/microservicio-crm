...
import { SubscriptionPlanCreatedEvent } from './subscriptionplancreated.event';
import { SubscriptionPlanUpdatedEvent } from './subscriptionplanupdated.event';
import { SubscriptionPlanDeletedEvent } from './subscriptionplandeleted.event';
import { PlanCreatedEvent } from './plancreated.event';
import { PlanUpdatedEvent } from './planupdated.event';
import { PlanDeletedEvent } from './plandeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'subscription-plan-created': createEventDefinition('subscription-plan-created', SubscriptionPlanCreatedEvent, EVENT_DEFINITION_OVERRIDES['subscription-plan-created']),
  'subscription-plan-updated': createEventDefinition('subscription-plan-updated', SubscriptionPlanUpdatedEvent, EVENT_DEFINITION_OVERRIDES['subscription-plan-updated']),
  'subscription-plan-deleted': createEventDefinition('subscription-plan-deleted', SubscriptionPlanDeletedEvent, EVENT_DEFINITION_OVERRIDES['subscription-plan-deleted']),
  'plan-created': createEventDefinition('plan-created', PlanCreatedEvent, EVENT_DEFINITION_OVERRIDES['plan-created']),
  'plan-updated': createEventDefinition('plan-updated', PlanUpdatedEvent, EVENT_DEFINITION_OVERRIDES['plan-updated']),
  'plan-deleted': createEventDefinition('plan-deleted', PlanDeletedEvent, EVENT_DEFINITION_OVERRIDES['plan-deleted']),
};
