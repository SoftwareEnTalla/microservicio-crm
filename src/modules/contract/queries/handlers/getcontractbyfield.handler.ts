...
import { GetContractByFieldQuery } from '../getcontractbyfield.query';
import { ContractQueryService } from '../../services/contractquery.service';

@QueryHandler(GetContractByFieldQuery)
export class GetContractByFieldHandler implements IQueryHandler<GetContractByFieldQuery> {
  constructor(private readonly queryService: ContractQueryService) {}

  async execute(query: GetContractByFieldQuery) {
