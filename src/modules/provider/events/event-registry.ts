...
import { ProviderCreatedEvent } from './providercreated.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'provider-created': createEventDefinition('provider-created', ProviderCreatedEvent, EVENT_DEFINITION_OVERRIDES['provider-created']),
