...
import { DeleteProviderCommand } from "../deleteprovider.command";
...
{
  constructor(
    private readonly commandService: ProviderCommandService
  ) {}
  async execute(command: DeleteProviderCommand) {
