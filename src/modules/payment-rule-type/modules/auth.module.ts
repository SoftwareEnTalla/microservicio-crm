...
@Module({
  controllers: [PaymentRuleTypeCommandController],
  providers: [
  ...
  exports: [PaymentRuleTypeAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthPaymentRuleTypeModule {}
