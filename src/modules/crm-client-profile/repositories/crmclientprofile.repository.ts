...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class CrmClientProfileRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[CrmClientProfile[], number]> {
      logger.info('Ready to findByField CrmClientProfile on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of CrmClientProfile with id:  was finded on repository:', instance);
