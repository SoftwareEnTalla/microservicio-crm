...
import { CrmClientProfileStatusCreatedEvent } from './crmclientprofilestatuscreated.event';
import { CrmClientProfileStatusUpdatedEvent } from './crmclientprofilestatusupdated.event';
import { CrmClientProfileStatusDeletedEvent } from './crmclientprofilestatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'crm-client-profile-status-created': createEventDefinition('crm-client-profile-status-created', CrmClientProfileStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['crm-client-profile-status-created']),
  'crm-client-profile-status-updated': createEventDefinition('crm-client-profile-status-updated', CrmClientProfileStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['crm-client-profile-status-updated']),
  'crm-client-profile-status-deleted': createEventDefinition('crm-client-profile-status-deleted', CrmClientProfileStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['crm-client-profile-status-deleted']),
