...
@Module({
  controllers: [PaymentMilestoneStatusCommandController],
  providers: [
  ...
  exports: [PaymentMilestoneStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthPaymentMilestoneStatusModule {}
