...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class PaymentMilestoneStatusRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[PaymentMilestoneStatus[], number]> {
      logger.info('Ready to findByField PaymentMilestoneStatus on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of PaymentMilestoneStatus with id:  was finded on repository:', instance);
