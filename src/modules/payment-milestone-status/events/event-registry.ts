...
import { PaymentMilestoneStatusCreatedEvent } from './paymentmilestonestatuscreated.event';
import { PaymentMilestoneStatusUpdatedEvent } from './paymentmilestonestatusupdated.event';
import { PaymentMilestoneStatusDeletedEvent } from './paymentmilestonestatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'payment-milestone-status-created': createEventDefinition('payment-milestone-status-created', PaymentMilestoneStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['payment-milestone-status-created']),
  'payment-milestone-status-updated': createEventDefinition('payment-milestone-status-updated', PaymentMilestoneStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['payment-milestone-status-updated']),
  'payment-milestone-status-deleted': createEventDefinition('payment-milestone-status-deleted', PaymentMilestoneStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['payment-milestone-status-deleted']),
