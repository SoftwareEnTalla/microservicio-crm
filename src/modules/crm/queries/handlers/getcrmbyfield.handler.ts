...
import { GetCrmByFieldQuery } from '../getcrmbyfield.query';
import { CrmQueryService } from '../../services/crmquery.service';

@QueryHandler(GetCrmByFieldQuery)
export class GetCrmByFieldHandler implements IQueryHandler<GetCrmByFieldQuery> {
  constructor(private readonly queryService: CrmQueryService) {}

  async execute(query: GetCrmByFieldQuery) {
