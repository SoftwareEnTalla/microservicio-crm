...
import { CrmCreatedEvent } from './crmcreated.event';
import { CrmUpdatedEvent } from './crmupdated.event';
import { CrmDeletedEvent } from './crmdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'crm-created': createEventDefinition('crm-created', CrmCreatedEvent, EVENT_DEFINITION_OVERRIDES['crm-created']),
  'crm-updated': createEventDefinition('crm-updated', CrmUpdatedEvent, EVENT_DEFINITION_OVERRIDES['crm-updated']),
  'crm-deleted': createEventDefinition('crm-deleted', CrmDeletedEvent, EVENT_DEFINITION_OVERRIDES['crm-deleted']),
