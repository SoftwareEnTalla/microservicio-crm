...
import { GetActivityByFieldQuery } from '../getactivitybyfield.query';
import { ActivityQueryService } from '../../services/activityquery.service';

@QueryHandler(GetActivityByFieldQuery)
export class GetActivityByFieldHandler implements IQueryHandler<GetActivityByFieldQuery> {
  constructor(private readonly queryService: ActivityQueryService) {}

  async execute(query: GetActivityByFieldQuery) {
