...
import { ContactCreatedEvent } from './contactcreated.event';
import { ContactUpdatedEvent } from './contactupdated.event';
import { ContactDeletedEvent } from './contactdeleted.event';
import { ContactLinkedToAccountEvent } from './contactlinkedtoaccount.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'contact-created': createEventDefinition('contact-created', ContactCreatedEvent, EVENT_DEFINITION_OVERRIDES['contact-created']),
  'contact-updated': createEventDefinition('contact-updated', ContactUpdatedEvent, EVENT_DEFINITION_OVERRIDES['contact-updated']),
  'contact-deleted': createEventDefinition('contact-deleted', ContactDeletedEvent, EVENT_DEFINITION_OVERRIDES['contact-deleted']),
  'contact-linked-to-account': createEventDefinition('contact-linked-to-account', ContactLinkedToAccountEvent, EVENT_DEFINITION_OVERRIDES['contact-linked-to-account']),
};
