...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class MilestoneStatusLogRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[MilestoneStatusLog[], number]> {
      logger.info('Ready to findByField MilestoneStatusLog on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of MilestoneStatusLog with id:  was finded on repository:', instance);
