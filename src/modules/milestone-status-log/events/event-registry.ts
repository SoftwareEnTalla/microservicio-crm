...
import { MilestoneStatusLogCreatedEvent } from './milestonestatuslogcreated.event';
import { MilestoneStatusLogUpdatedEvent } from './milestonestatuslogupdated.event';
import { MilestoneStatusLogDeletedEvent } from './milestonestatuslogdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'milestone-status-log-created': createEventDefinition('milestone-status-log-created', MilestoneStatusLogCreatedEvent, EVENT_DEFINITION_OVERRIDES['milestone-status-log-created']),
  'milestone-status-log-updated': createEventDefinition('milestone-status-log-updated', MilestoneStatusLogUpdatedEvent, EVENT_DEFINITION_OVERRIDES['milestone-status-log-updated']),
  'milestone-status-log-deleted': createEventDefinition('milestone-status-log-deleted', MilestoneStatusLogDeletedEvent, EVENT_DEFINITION_OVERRIDES['milestone-status-log-deleted']),
