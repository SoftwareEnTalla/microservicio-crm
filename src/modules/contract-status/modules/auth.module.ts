...
@Module({
  controllers: [ContractStatusCommandController],
  providers: [
  ...
  exports: [ContractStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthContractStatusModule {}
