...
import { ContractStatusCreatedEvent } from './contractstatuscreated.event';
import { ContractStatusUpdatedEvent } from './contractstatusupdated.event';
import { ContractStatusDeletedEvent } from './contractstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'contract-status-created': createEventDefinition('contract-status-created', ContractStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['contract-status-created']),
  'contract-status-updated': createEventDefinition('contract-status-updated', ContractStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['contract-status-updated']),
  'contract-status-deleted': createEventDefinition('contract-status-deleted', ContractStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['contract-status-deleted']),
