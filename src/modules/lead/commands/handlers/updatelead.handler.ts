...
import { UpdateLeadCommand } from "../updatelead.command";
...
export class UpdateLeadHandler
  implements ICommandHandler<UpdateLeadCommand>
{
  constructor(
    private readonly commandService: LeadCommandService
  ) {}
  async execute(command: UpdateLeadCommand) {
