...
import { GetIncentiveByFieldQuery } from '../getincentivebyfield.query';
import { IncentiveQueryService } from '../../services/incentivequery.service';

@QueryHandler(GetIncentiveByFieldQuery)
export class GetIncentiveByFieldHandler implements IQueryHandler<GetIncentiveByFieldQuery> {
  constructor(private readonly queryService: IncentiveQueryService) {}

  async execute(query: GetIncentiveByFieldQuery) {
