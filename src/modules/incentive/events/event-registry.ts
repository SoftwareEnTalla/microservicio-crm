...
import { IncentiveCreatedEvent } from './incentivecreated.event';
import { IncentiveUpdatedEvent } from './incentiveupdated.event';
import { IncentiveDeletedEvent } from './incentivedeleted.event';
import { IncentiveAppliedEvent } from './incentiveapplied.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'incentive-created': createEventDefinition('incentive-created', IncentiveCreatedEvent, EVENT_DEFINITION_OVERRIDES['incentive-created']),
  'incentive-updated': createEventDefinition('incentive-updated', IncentiveUpdatedEvent, EVENT_DEFINITION_OVERRIDES['incentive-updated']),
  'incentive-deleted': createEventDefinition('incentive-deleted', IncentiveDeletedEvent, EVENT_DEFINITION_OVERRIDES['incentive-deleted']),
  'incentive-applied': createEventDefinition('incentive-applied', IncentiveAppliedEvent, EVENT_DEFINITION_OVERRIDES['incentive-applied']),
};
