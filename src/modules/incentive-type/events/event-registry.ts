...
import { IncentiveTypeCreatedEvent } from './incentivetypecreated.event';
import { IncentiveTypeUpdatedEvent } from './incentivetypeupdated.event';
import { IncentiveTypeDeletedEvent } from './incentivetypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'incentive-type-created': createEventDefinition('incentive-type-created', IncentiveTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['incentive-type-created']),
  'incentive-type-updated': createEventDefinition('incentive-type-updated', IncentiveTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['incentive-type-updated']),
  'incentive-type-deleted': createEventDefinition('incentive-type-deleted', IncentiveTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['incentive-type-deleted']),
