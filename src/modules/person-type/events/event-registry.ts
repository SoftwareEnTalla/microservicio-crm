...
import { PersonTypeCreatedEvent } from './persontypecreated.event';
import { PersonTypeUpdatedEvent } from './persontypeupdated.event';
import { PersonTypeDeletedEvent } from './persontypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'person-type-created': createEventDefinition('person-type-created', PersonTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['person-type-created']),
  'person-type-updated': createEventDefinition('person-type-updated', PersonTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['person-type-updated']),
  'person-type-deleted': createEventDefinition('person-type-deleted', PersonTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['person-type-deleted']),
