...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class BillingCycleQueryRepository {

    //Constructor del repositorio de datos: BillingCycleQueryRepository
    constructor(
    ...
    async findWithPagination(
      ...
      logger.info('Ready to findWithPagination BillingCycle on repository:', options);
      return this.repository.find(options);
    }
    ...
    async findAndCount(where?: Record<string, any>): Promise<[BillingCycle[], number]> {
      logger.info('Ready to findAndCount BillingCycle on repository:',where);
      let result= this.repository.findAndCount({
        where: where,
      });
      logger.info('Was counted  instances of BillingCycle on repository:',result);
      return result;
    }
