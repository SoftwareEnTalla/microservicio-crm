...
import { BillingCycleCreatedEvent } from './billingcyclecreated.event';
import { BillingCycleUpdatedEvent } from './billingcycleupdated.event';
import { BillingCycleDeletedEvent } from './billingcycledeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'billing-cycle-created': createEventDefinition('billing-cycle-created', BillingCycleCreatedEvent, EVENT_DEFINITION_OVERRIDES['billing-cycle-created']),
  'billing-cycle-updated': createEventDefinition('billing-cycle-updated', BillingCycleUpdatedEvent, EVENT_DEFINITION_OVERRIDES['billing-cycle-updated']),
  'billing-cycle-deleted': createEventDefinition('billing-cycle-deleted', BillingCycleDeletedEvent, EVENT_DEFINITION_OVERRIDES['billing-cycle-deleted']),
