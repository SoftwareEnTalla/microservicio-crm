...
@Module({
  controllers: [PaymentMilestoneCommandController],
  providers: [
  ...
  exports: [PaymentMilestoneAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthPaymentMilestoneModule {}
