...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class PaymentMilestoneRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[PaymentMilestone[], number]> {
      logger.info('Ready to findByField PaymentMilestone on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of PaymentMilestone with id:  was finded on repository:', instance);
