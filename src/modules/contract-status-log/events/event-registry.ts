...
import { ContractStatusLogCreatedEvent } from './contractstatuslogcreated.event';
import { ContractStatusLogUpdatedEvent } from './contractstatuslogupdated.event';
import { ContractStatusLogDeletedEvent } from './contractstatuslogdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'contract-status-log-created': createEventDefinition('contract-status-log-created', ContractStatusLogCreatedEvent, EVENT_DEFINITION_OVERRIDES['contract-status-log-created']),
  'contract-status-log-updated': createEventDefinition('contract-status-log-updated', ContractStatusLogUpdatedEvent, EVENT_DEFINITION_OVERRIDES['contract-status-log-updated']),
  'contract-status-log-deleted': createEventDefinition('contract-status-log-deleted', ContractStatusLogDeletedEvent, EVENT_DEFINITION_OVERRIDES['contract-status-log-deleted']),
