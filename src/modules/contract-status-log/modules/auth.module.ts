...
@Module({
  controllers: [ContractStatusLogCommandController],
  providers: [
  ...
  exports: [ContractStatusLogAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthContractStatusLogModule {}
