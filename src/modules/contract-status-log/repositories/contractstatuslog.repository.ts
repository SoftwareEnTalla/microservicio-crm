...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class ContractStatusLogRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[ContractStatusLog[], number]> {
      logger.info('Ready to findByField ContractStatusLog on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of ContractStatusLog with id:  was finded on repository:', instance);
