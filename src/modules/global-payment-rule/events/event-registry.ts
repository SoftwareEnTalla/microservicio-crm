...
import { GlobalPaymentRuleCreatedEvent } from './globalpaymentrulecreated.event';
import { GlobalPaymentRuleUpdatedEvent } from './globalpaymentruleupdated.event';
import { GlobalPaymentRuleDeletedEvent } from './globalpaymentruledeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'global-payment-rule-created': createEventDefinition('global-payment-rule-created', GlobalPaymentRuleCreatedEvent, EVENT_DEFINITION_OVERRIDES['global-payment-rule-created']),
  'global-payment-rule-updated': createEventDefinition('global-payment-rule-updated', GlobalPaymentRuleUpdatedEvent, EVENT_DEFINITION_OVERRIDES['global-payment-rule-updated']),
  'global-payment-rule-deleted': createEventDefinition('global-payment-rule-deleted', GlobalPaymentRuleDeletedEvent, EVENT_DEFINITION_OVERRIDES['global-payment-rule-deleted']),
