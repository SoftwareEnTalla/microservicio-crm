...
@Module({
  controllers: [GlobalPaymentRuleCommandController],
  providers: [
  ...
  exports: [GlobalPaymentRuleAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthGlobalPaymentRuleModule {}
